...
real(kind=dp),public,parameter	::iturrix=1.0_dp,iturriy=3.5_dp,iturriz=1.60_dp,detektore1=1.15_dp
...
!oztopoak
integer,public,parameter::zenbat_oztopo=6 !1-tarima, 2-it kutxa, 3-irakasle mahaia, 4-5-6-ikasle_mahaiak
real(kind=dp),public,dimension(zenbat_oztopo,3)::obloke=reshape((/0.0_dp,0.0_dp,0.0_dp,&
...
real(kind=dp),public,dimension(zenbat_oztopo)::xbloke=(/2.44_dp,2.44_dp,2.44_dp,12.7_dp,12.7_dp,12.7_dp/)
real(kind=dp),public,dimension(zenbat_oztopo)::ybloke=(/6.0_dp,1.5_dp,3.8_dp,1.7_dp,4.4_dp,7.1_dp/)
real(kind=dp),public,dimension(zenbat_oztopo)::zbloke=(/0.3_dp,1.14_dp,1.35_dp,0.77_dp,0.77_dp,0.77_dp/)
end module m_datuak
