...
call oztopo(ind(obloke(1)),ind(obloke(2)),ind(obloke(3)),ind(xbloke),ind(ybloke),ind(zbloke))
!hormak
oztoporik(-1,:,:)=0
oztoporik(nx+1,:,:)=0
oztoporik(:,-1,:)=0
...
do i=0,nx
	...
	call mb_p_oztopo(p_berria,u_orain,v_orain,w_orain,zn_xurgakor,ind(obloke(1)),ind(obloke(2)),ind(obloke(3)),ind(xbloke),ind(ybloke),ind(zbloke))
	...
	call mb_u_oztopo(p_berria,u_berria,v_berria,w_berria,zn_xurgakor,ind(obloke(1)),ind(obloke(2)),ind(obloke(3)),ind(xbloke),ind(ybloke),ind(zbloke))
